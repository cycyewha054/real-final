      ...
      <div className="bg-gray-100 pt-8 pb-36 mx-auto w-[400px] ">
        <div className="flex flex-row w-full justify-between ">
          <div className=" border mx-4 mb-4 w-full rounded-xl shadow-sm">
            <button
              className="py-2 w-1/2 rounded-l-xl bg-neutral-50 hover:bg-neutral-100 transition"
              onClick={() => {
                push('alertwritten');
              }}
            >
            ...
            <button
              className=" py-2 w-1/2 rounded-r-xl text-white  bg-orange-600 hover:bg-red-600  transition"
              onClick={() => {
                push('alertoption');
              }}
            >
