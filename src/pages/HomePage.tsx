      ...
      <div className="bg-gray-100 pt-12 pb-36 mx-auto w-[400px] ">
        ...
        <div className="grid grid-cols-1 gap-6 my-6 px-4 md:px-6 lg:px-8">
          {posts.map((post) => {
            ...
            const { brand, prNo, prName, prOption, additional } = attributes;
                ...
                <div className="w-full">
                  ...
                  <div className="flex justify-start mb-4 ">
                    <div className="flex justify-end w-full  pr-5">
                      ...
                      >
                        <div className="flex justify-end space-x-3 ">
                          <div className="bg-orange-500 hover:bg-orange-600 shadow-md rounded-md text-white text-center py-2 px-3 test-xs">
                            옵션 추가
                          </div>
                        </div>
                      </button>
